  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-primary-100 dark:from-dark-900 dark:via-dark-800 dark:to-dark-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-primary-300 dark:bg-primary-700 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-bounce-slow" style={{ animationDelay: '2s' }} />
        <div className="absolute top-40 left-1/2 w-80 h-80 bg-primary-400 dark:bg-primary-600 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-bounce-slow" style={{ animationDelay: '4s' }} />
      </div>
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              ...
              <br />
              <span className="text-dark-900 dark:text-white">Your Name</span>
            </h1>
          ...
          >
            <div className="flex items-center justify-center space-x-3 p-4 bg-white/50 dark:bg-dark-800/50 backdrop-blur-sm rounded-lg">
              ...
              <span className="font-medium text-dark-700 dark:text-gray-300">Clean Code</span>
            </div>
            <div className="flex items-center justify-center space-x-3 p-4 bg-white/50 dark:bg-dark-800/50 backdrop-blur-sm rounded-lg">
              <Palette className="h-6 w-6 text-primary-600" />
              <span className="font-medium text-dark-700 dark:text-gray-300">Modern Design</span>
            </div>
            <div className="flex items-center justify-center space-x-3 p-4 bg-white/50 dark:bg-dark-800/50 backdrop-blur-sm rounded-lg">
              <Zap className="h-6 w-6 text-primary-600" />
              <span className="font-medium text-dark-700 dark:text-gray-300">Fast & Reliable</span>
            </div>
          </motion.div>
        </div>
      </div>
